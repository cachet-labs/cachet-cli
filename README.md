...
Using Claude Code, Cursor, Windsurf, or any [skills.sh](https://skills.sh)-compatible agent? Install the cachet skill for in-editor setup guidance, command reference, and troubleshooting:
